...
def mainprogram():
    ...
    Label(root1,text='Developed as part of the course Advanced Programming Lab & DBMS',fg='#15DAC1',font='Arial 20 bold',background='#454445').grid(row=1,column=0)
    Label(root1,text='Developed By: Rahul Singh (191B317)',fg='red',font='Arial 20 bold',background='#454445').grid(row=2,column=0)
    Label(root1,text='-------------------------------------------------',fg='yellow',font='Arial 20 bold',background='#454445').grid(row=3,column=0)
    Label(root1,text='Project Supervisors: Dr Mahesh Kumar & Dr Nileshpatel R Kumar and Dr.Amit Kumar Srivastava',fg='#15DAC1',font='Arial 20 bold',background='#454445').grid(row=4,column=0)
    ...
    lb1=Label(root,text='PACIFIC BUS BOOKING SERVICE',fg='red',relief=SUNKEN,font=('Times',30),background="#2E2E03")
